...
const mobs = {
    ...
    spawn(xPos, yPos, sides, radius, color) {
        ...
        mob[i] = Matter.Bodies.polygon(xPos, yPos, sides, radius, {
            ...
            replace(i) {
                const allowBodyReplacement = !(typeof multiplayer !== 'undefined' && multiplayer.enabled);
                //if there are too many bodies don't turn into blocks to help performance
                if (allowBodyReplacement && this.leaveBody && body.length < 60 && this.mass < 200 && this.radius > 18) {
